...
name: CODELEAN-help
description: >
  Quick-reference card for all CODELEAN modes, skills, and commands.
  One-shot display, not a persistent mode. Trigger: /CODELEAN-help,
  "CODELEAN help", "what CODELEAN commands", "how do I use CODELEAN".
---
