...
description: >
  Show CURLYCODER's measured impact as a compact scoreboard: less code, less
  cost, more speed, from the benchmark medians. One-shot display, not a
  persistent mode, and not a per-repo number. Trigger: /CURLYCODER-gain,
  "CURLYCODER gain", "what does CURLYCODER save", "show CURLYCODER impact",
  "CURLYCODER scoreboard".
---
