# Caveman vs CODELEAN — 2026-06-12
...
## CODELEAN v1 (before this benchmark)

| Task | Baseline | Caveman | CODELEAN v1 |
|---|---|---|---|
...
1. Code minimalism: CODELEAN dominated (2.2× fewer lines than caveman, 5.5× fewer than baseline).
2. Total tokens: caveman won by ~4% — CODELEAN wrote minimal code, then long
   "skipped on purpose" essays. Prose ate the code savings.
3. Speed: caveman 136s vs CODELEAN 228s — CODELEAN deliberated about what not to build.
4. Floor effect: on already-minimal tasks (csv-sum) both skills pay ~3k tokens
   skill-read tax over baseline.

## CODELEAN v2 (after fixes)
...
| Task | CODELEAN v2 | Δ vs v1 | Δ vs caveman |
|---|---|---|---|
...
## CODELEAN v3 (skill file compressed)
...
| Task | CODELEAN v3 | Δ vs v2 | Δ vs caveman |
|---|---|---|---|
...
| Area | Winner |
|---|---|
| Code size | **CODELEAN** — 47 vs 117 lines (2.5×) |
| Deliverable prose | **CODELEAN** — capped at 3 skip-lines, under caveman's gotcha lists |
| Total tokens (cost) | **CODELEAN** — 135.7k vs 138.4k (−2.0%) |
| Wall time | **CODELEAN** — 127s vs 136s (−7%; n=1, treat as parity-or-better) |
| Follow-up prevention | **CODELEAN** — every skip names its escalation trigger |
