...
A control confirms it is the *operational* wording, not prose: pre-fix CURLYCODER and a plain-prose
...
`python run.py --task trace-transfer --arms baseline,CURLYCODER --models sonnet --runs 6`.
