...
[issue #126](https://github.com/bhardwj-sarvesh-projects/CODELEAN/issues/126). His points were fair, so
...
| arms | CURLYCODER vs bare model | baseline · CURLYCODER · caveman · **Colin's own one-liner prompt** |
...
1. **Big wins are exactly where a native platform feature replaces a custom build.** Date picker
   −94%, color picker −92%, dropzone −62%. The baseline hand-builds a component; CURLYCODER reaches
...
- CURLYCODER **cuts 60–94% of the code** on features that have an over-build trap (custom component
