# Caveman vs CURLYCODER — 2026-06-12
...
## CURLYCODER v1 (before this benchmark)

| Task | Baseline | Caveman | CURLYCODER v1 |
|---|---|---|---|
...
1. Code minimalism: CURLYCODER dominated (2.2× fewer lines than caveman, 5.5× fewer than baseline).
2. Total tokens: caveman won by ~4% — CURLYCODER wrote minimal code, then long
   "skipped on purpose" essays. Prose ate the code savings.
3. Speed: caveman 136s vs CURLYCODER 228s — CURLYCODER deliberated about what not to build.
4. Floor effect: on already-minimal tasks (csv-sum) both skills pay ~3k tokens
   skill-read tax over baseline.

## CURLYCODER v2 (after fixes)
...
| Task | CURLYCODER v2 | Δ vs v1 | Δ vs caveman |
|---|---|---|---|
...
## CURLYCODER v3 (skill file compressed)
...
| Task | CURLYCODER v3 | Δ vs v2 | Δ vs caveman |
|---|---|---|---|
...
| Area | Winner |
|---|---|
| Code size | **CURLYCODER** — 47 vs 117 lines (2.5×) |
| Deliverable prose | **CURLYCODER** — capped at 3 skip-lines, under caveman's gotcha lists |
| Total tokens (cost) | **CURLYCODER** — 135.7k vs 138.4k (−2.0%) |
| Wall time | **CURLYCODER** — 127s vs 136s (−7%; n=1, treat as parity-or-better) |
| Follow-up prevention | **CURLYCODER** — every skip names its escalation trigger |
