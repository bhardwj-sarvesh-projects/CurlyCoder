...
Context: the README headline says CURLYCODER is "47-77% cheaper." This is a fresh
...
- On Claude, CURLYCODER is **42-75% cheaper** than no-skill across Haiku, Sonnet, and Opus
...
- Correctness is not hurt anywhere: CURLYCODER scores **100%** on every Claude and OpenAI
...
Three arms (no skill, caveman, CURLYCODER) on Claude; baseline vs CURLYCODER on OpenAI. Five
...
| model | baseline | caveman | CURLYCODER | CURLYCODER vs baseline |
|---|--:|--:|--:|--:|
| Haiku | 0.0299 | 0.0139 | 0.0110 | **63.1% cheaper** |
| Sonnet | 0.1367 | 0.0458 | 0.0348 | **74.5% cheaper** |
| Opus | 0.1368 | 0.0724 | 0.0789 | **42.3% cheaper** |

**Range: 42-75% cheaper** (vs the published 47-77%). Latency 3.1-5.8x faster; CURLYCODER
correctness 100% on all three.

### OpenAI (10 reps, USD for 5 tasks)

| model | baseline | CURLYCODER | CURLYCODER vs baseline | latency | correctness |
|---|--:|--:|--:|--:|--:|
...
The reasoning models (gpt-5.4-mini, gpt-5.5) cost more under CURLYCODER: the ruleset is
...
gemini-3.1-pro-preview (top), baseline vs CURLYCODER.
...
models, including the newest top model gpt-5.5, CURLYCODER costs more, not less. The number is
