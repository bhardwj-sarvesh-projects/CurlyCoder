...
Context: the README headline says CODELEAN is "47-77% cheaper." This is a fresh
...
- On Claude, CODELEAN is **42-75% cheaper** than no-skill across Haiku, Sonnet, and Opus
...
- Correctness is not hurt anywhere: CODELEAN scores **100%** on every Claude and OpenAI
...
Three arms (no skill, caveman, CODELEAN) on Claude; baseline vs CODELEAN on OpenAI. Five
...
| model | baseline | caveman | CODELEAN | CODELEAN vs baseline |
|---|--:|--:|--:|--:|
| Haiku | 0.0299 | 0.0139 | 0.0110 | **63.1% cheaper** |
| Sonnet | 0.1367 | 0.0458 | 0.0348 | **74.5% cheaper** |
| Opus | 0.1368 | 0.0724 | 0.0789 | **42.3% cheaper** |

**Range: 42-75% cheaper** (vs the published 47-77%). Latency 3.1-5.8x faster; CODELEAN
correctness 100% on all three.

### OpenAI (10 reps, USD for 5 tasks)

| model | baseline | CODELEAN | CODELEAN vs baseline | latency | correctness |
|---|--:|--:|--:|--:|--:|
...
The reasoning models (gpt-5.4-mini, gpt-5.5) cost more under CODELEAN: the ruleset is
...
gemini-3.1-pro-preview (top), baseline vs CODELEAN.
...
models, including the newest top model gpt-5.5, CODELEAN costs more, not less. The number is
