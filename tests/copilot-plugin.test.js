...
const REQUIRED_COMMAND_FILES = [
  'CURLYCODER.toml',
  'CURLYCODER-review.toml',
  'CURLYCODER-audit.toml',
  'CURLYCODER-debt.toml',
  'CURLYCODER-gain.toml',
  'CURLYCODER-help.toml',
];
...
test('copilot plugin command directory includes CURLYCODER-debt', () => {
