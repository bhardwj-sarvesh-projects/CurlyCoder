...
// always-on context, commands/*.toml for /CODELEAN + /CODELEAN-review, and
...
// carries the load-bearing rules — i.e. if the adapter stops wiring CODELEAN.
...
test('manifest names the CODELEAN extension with a pinned version', () => {
...
test('contextFileName resolves to a file carrying the CODELEAN rules', () => {
  const manifest = loadManifest();
