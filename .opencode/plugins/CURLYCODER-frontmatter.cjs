...
// CURLYCODER command-file frontmatter parser.
//
// Pulled out of CURLYCODER.mjs so the plugin module's only top-level export is
...
// leaves exactly one plugin-shaped export on CURLYCODER.mjs.
